    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-700">
                <h1 class="text-2xl font-bold text-white">Edit Theater: {{ $theater->name }}</h1>
            </div>

            <form action="{{ route('admin.theaters.update', $theater->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $theater->name) }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $theater->capacity) }}"
                               class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <select id="type" name="type"
                            ...
                            <option value="premium" {{ old('type', $theater->type) == 'premium' ? 'selected' : '' }}>Premium</option>
                    ...
                    <div>
                        ...
                        <input type="number" id="rows" name="rows" value="{{ old('rows', $theater->rows) }}"
                               class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-red-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="number" id="seats_per_row" name="seats_per_row" value="{{ old('seats_per_row', $theater->seats_per_row) }}"
                               class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-red-500 focus:border-transparent"
